...
impl Rate {
    ...
    pub fn apply(
        ...
        IntermediateAmount::from_exact(result_whole)
    }
}
...
mod tests {
    ...
    fn rate_5_percent_multiply_first() {
        ...
        let result = rate.apply(&exact(2_000_000), MultiplyOrder::MultiplyFirst, RoundingStrategy::Floor);
    ...
    fn rate_3_percent_tier3() {
        ...
        let result = rate.apply(&exact(1_000_000), MultiplyOrder::MultiplyFirst, RoundingStrategy::Floor);
    ...
    fn multiply_first_vs_divide_first_differ() {
        ...
        let mf = rate.apply(&exact(7), MultiplyOrder::MultiplyFirst, RoundingStrategy::Floor);
        let df = rate.apply(&exact(7), MultiplyOrder::DivideFirst, RoundingStrategy::Floor);
    ...
    fn tax_10_percent() {
        ...
        let result = rate.apply(&exact(210_000), MultiplyOrder::MultiplyFirst, RoundingStrategy::Floor);
