...
fn edge_10k_exact() {
    ...
    let result =
        calculate_stamp_tax(&ctx(10_000, LegalDate::new(2024, 8, 1), false), &params).unwrap();
...
fn edge_100k_exact() {
    let params = load_stamp_tax_params(LegalDate::new(2024, 8, 1)).unwrap();
    let result =
        calculate_stamp_tax(&ctx(100_000, LegalDate::new(2024, 8, 1), false), &params).unwrap();
    assert_eq!(result.tax_amount.as_yen(), 200);
}
...
fn edge_100k_plus1() {
    let params = load_stamp_tax_params(LegalDate::new(2024, 8, 1)).unwrap();
    let result =
        calculate_stamp_tax(&ctx(100_001, LegalDate::new(2024, 8, 1), false), &params).unwrap();
...
fn edge_100k_reduced_flag_no_effect() {
    let params = load_stamp_tax_params(LegalDate::new(2024, 8, 1)).unwrap();
    let result =
        calculate_stamp_tax(&ctx(100_000, LegalDate::new(2024, 8, 1), true), &params).unwrap();
    assert_eq!(result.tax_amount.as_yen(), 200);
...
fn edge_100k_plus1_reduced() {
    let params = load_stamp_tax_params(LegalDate::new(2024, 8, 1)).unwrap();
    let result =
        calculate_stamp_tax(&ctx(100_001, LegalDate::new(2024, 8, 1), true), &params).unwrap();
    assert_eq!(result.tax_amount.as_yen(), 200);
    assert!(result.reduced_rate_applied);
}
...
fn reduced_period_first_day() {
    ...
    let result =
        calculate_stamp_tax(&ctx(5_000_000, LegalDate::new(2014, 4, 1), true), &params).unwrap();
...
fn reduced_period_last_day() {
    ...
    let result =
        calculate_stamp_tax(&ctx(5_000_000, LegalDate::new(2027, 3, 31), true), &params).unwrap();
    assert_eq!(result.tax_amount.as_yen(), 1_000);
    assert!(result.reduced_rate_applied);
}
...
fn reduced_period_day_after() {
    ...
    let result =
        calculate_stamp_tax(&ctx(5_000_000, LegalDate::new(2027, 4, 1), true), &params).unwrap();
...
fn zero_amount() {
    let params = load_stamp_tax_params(LegalDate::new(2024, 8, 1)).unwrap();
    let result = calculate_stamp_tax(&ctx(0, LegalDate::new(2024, 8, 1), false), &params).unwrap();
    assert_eq!(result.tax_amount.as_yen(), 0);
}
